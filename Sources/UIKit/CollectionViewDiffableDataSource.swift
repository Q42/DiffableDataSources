...
open class CollectionViewDiffableDataSource<SectionIdentifierType: Hashable, ItemIdentifierType: Hashable>: NSObject, UICollectionViewDataSource where SectionIdentifierType: ContentEquatable, ItemIdentifierType: ContentEquatable {
